  ...
  faqs: [
    {
      ...
      answer: (
        <span>
          MedSage is an AI-powered medical assistant that provides real-time voice conversations to help answer your health questions. It uses advanced speech-to-text and text-to-speech technology to create a natural, conversational experience.
        </span>
      ),
    },
    {
    ...
    {
      question: "Can MedSage replace my actual doctor?",
      answer: (
        <span>
          No, MedSage is designed to be a helpful resource but is not a replacement for professional medical care. Always consult with a qualified healthcare professional for medical advice, diagnosis, and treatment.
        </span>
      ),
    },
    {
